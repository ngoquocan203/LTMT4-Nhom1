							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-8">
									<div class="form-group" >
										...
										<input required type="text" name="name" class="form-control" value="{{$products->name}}">
									</div>
									<div class="form-group" >
									...
									<div class="form-group" >
										...
										<input required type="number" name="promotion_price" class="form-control" value="{{$products->promotion_price}}">
									</div>
									<div class="form-group" >
									...
									<div class="form-group">
										...
										<textarea class="form-control" required name="content" ><p>{{$products->content}}</p></textarea>
									</div>
									<div class="form-group" >
